<x-layouts.sidebar>
    <x-slot:title>Mini Maktab</x-slot:title>

    <div class="oz-wrap">
        <div class="oz-title">Mini Maktab — Bolimlar</div>
                ...
                <tbody>
                    @foreach ($bolimlar as $bolim)
                        <tr style="cursor:pointer;"
                            onclick="window.location='{{ route('mini_maktab.fanlar', $bolim->id) }}'">
                            ...
                            <td>
                                <span style="font-size:13px; color:#888;">
                                    {{ $bolim->mini_semestrs->count() ?? 0 }} ta
                                </span>
                            </td>
