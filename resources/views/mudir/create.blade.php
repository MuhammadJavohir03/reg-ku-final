<x-layouts.sidebar>
    <x-slot:title>Yangi mudir qo'shish</x-slot:title>
    ...
    <div class="sf-wrap">
        ...
        <div class="sf-header">
            ...
            <div>
                <div class="oz-title" style="margin:0;">Yangi mudir qo'shish</div>
                <div class="sf-subtitle">Kafedra mudiri haqida ma'lumotlarni to'ldiring</div>
            </div>
        </div>
        ...
        <form action="{{ route('mudir.store') }}" method="POST">
            @csrf
    ...
    <script>
        // Har bir qidiruvli dropdown uchun umumiy funksiya (subject/create.blade.php bilan bir xil mantiq)
