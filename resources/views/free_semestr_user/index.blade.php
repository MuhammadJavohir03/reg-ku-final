<x-layouts.sidebar>
    ...
    <x-slot:title>
        Ariza Topshirish | Bepul Semestr
    </x-slot:title>

    <div class="oz-wrap">

        <div class="oz-banner">
            <div class="oz-banner-badge"><i class="bx bx-file"></i> ARIZA TIZIMI (Bepul Maktab)</div>
            <h1>Bepul Maktabga ariza topshirish</h1>
        ...
        <div class="oz-step">
            ...
            <div class="oz-step-body">
                ...
                <div class="oz-limit-counter">
                    ...
                    <span><strong id="selectedCount">{{ $submittedCount }}</strong> / 8</span>
                </div>

                <form action="{{ route('free_semestr_user.store') }}" method="POST" id="subjectForm">
                    @csrf
                        ...
                        @foreach ($subjects as $subject)
                            ...
                            <div class="oz-subject-item {{ $isSubmitted ? 'is-checked' : '' }}"
                                ...
                                <label class="oz-subject-label">
                                    ...
                                    <span>{{ $subject->nomi }} - {{($subject->semster)}}</span>
                                </label>
                                @if ($isSubmitted)
