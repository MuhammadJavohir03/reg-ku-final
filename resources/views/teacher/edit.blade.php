<x-layouts.sidebar>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="form-title
                mb-4 fw-bold text-dark border-start border-primary border-4 ps-3">O'qituvchilarni tahrirlash</h2>
            <form action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="To‘liq_ismi" class="form-label">To'liq ismi</label>
                    <input value="{{ $teacher['To‘liq_ismi'] }}" type="text" name="To‘liq_ismi" class="form-control"
